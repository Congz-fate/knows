...
public class CodeGenerator {
    ...
    //父级别包名称                                  ↓↓↓↓↓
    public static String parentPackage = "com.zc";
    //代码生成的目标路径                   ↓↓↓↓↓
    ...
    //作者名
    public static String author = "zc.com";
    //模块名称，用于组成包名
    public static String modelName = "knowsportal";
